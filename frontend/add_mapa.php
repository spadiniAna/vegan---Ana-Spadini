...
> 
  <div class="form-inner-wrapper" >
    <form
       method="POST"
       action="../backend/salvar_mapa.php"
    ...
    >
        <div class="field-list clear">
              ...
              <div id="descr-field" class="form-item field descr required">
                
                <label class="title" for="descr">
                  Descrição             
                  
                </label>
                             
                    <input
                        class="field-element descr"
                        type="text"
                        id="descr"
                        value="<?php if(isset($descr)){ echo $descr; } ?>"
                        name="descr"
                        />
              </div>
 
              <div id="loc-field" class="form-item field loc required">

              <label class="title" for="loc">
                  Localização             
                  
                </label>
                             
                    <input
                        class="field-element loc"
                        type="text"
                        id="loc"
                        value="<?php if(isset($loc)){ echo $loc; } ?>"
                        name="loc"
            ...
            <div id="img-field" class=" form-item img sqs-layout" >
