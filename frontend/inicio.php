    ...
    ?>
                ...
                <div id="promotedGalleryWrapper" class="sqs-layout promoted-gallery-wrapper"><div class="row"><div class="col"></div></div></div>
                    ...
                    <div class="banner-thumbnail-wrapper has-description" data-content-field="main-image" data-collection-id="62fbdce4aeddd349cbd69258" data-edit-main-image="" data-annotation-alignment="bottom left">
                      ...
                      <div class="desc-wrapper" data-content-field="description" data-collection-id="62fbdce4aeddd349cbd69258"><p class="" style="white-space:pre-wrap;">Sustentabilidade</p><p class="" style="white-space:pre-wrap;"><strong>Começa com você</strong></p></div>
                    </div>
                ...
                <div class="image-button-wrapper">
                  <div class="image-button sqs-dynamic-text">
                    <div class="image-button-inner">
                      <a href="receitas.php" class="sqs-button-element--primary">Saiba mais</a>
                    </div>
                  </div>
                </div>
...
><p class="" style="white-space:pre-wrap;">Encontre lugares perto de você que compartilhem da filosofia cruelty free</p></div></div>
                ...
                <div class="image-button-wrapper">
                  <div class="image-button sqs-dynamic-text">
                    <div class="image-button-inner">
                      <a href="mapa.php" class="sqs-button-element--primary">Saiba mais</a>
                    </div>
                  </div>
                </div>
...
><p class="" style="white-space:pre-wrap;">Fique por dentro do mundo vegano e de todas as suas novidades</p></div></div>
                ...
                <div class="image-button-wrapper">
                  <div class="image-button sqs-dynamic-text">
                    <div class="image-button-inner">
                      <a href="blog.php" class="sqs-button-element--primary">saiba mais</a>
                    </div>
                  </div>
                </div>
