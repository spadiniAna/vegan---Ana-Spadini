 ...
 ?>      
                <div id="promotedGalleryWrapper" class="sqs-layout promoted-gallery-wrapper"><div class="row"><div class="col"></div></div></div>
                    ...
                    <div class="banner-thumbnail-wrapper has-description" data-content-field="main-image" data-collection-id="62f13a4adfaf885f6a5d4a3f" data-edit-main-image="" data-annotation-alignment="bottom left">
                      ...
                      <div class="desc-wrapper" data-content-field="description" data-collection-id="62f13a4adfaf885f6a5d4a3f"><p class="" style="white-space:pre-wrap;"><strong>Blog</strong></p></div>
                    </div>
      ...
      <div class="sqs-block html-block sqs-block-html" data-block-type="2" id="block-62fbe3148303cb726b7e5684"><div class="sqs-block-content">
        <p class="" style="white-space:pre-wrap;"><?php if(isset($texto)){ echo $texto; } ?></p>
...
function exclu(n){
    ...
    window.location = '/vegan/backend/excluir_blog.php?id=' + n;

}

function edit(n){

    window.location = 'add_blog.php?id=' + n;
